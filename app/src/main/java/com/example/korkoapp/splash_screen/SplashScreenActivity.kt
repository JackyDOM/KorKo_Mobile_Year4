package com.example.korkoapp.splash_screen
...
import com.example.korkoapp.buttonNavigationBar_Screen.MainActivityButtonNavBar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nextbtn.setOnClickListener {
            if (getitem(0) < 3) {
                ...
                val intent = Intent(this@SplashScreenActivity, MainActivityButtonNavBar::class.java)
